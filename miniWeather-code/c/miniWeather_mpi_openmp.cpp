...
double pow_pole(double base, double exponent) {
  ...
  double a = base;
    if(a < 250)
  return -1.70735106332555e-10*a*a*a*a*a + 1.77301841191499e-7*a*a*a*a - 8.64346475808559e-5*a*a*a + 0.0345738590323423*a*a + 3.88955914113852*a - 33.3390783526161;
  else
  return -2.71435927511651e-11*a*a*a*a*a + 4.69792951462474e-8*a*a*a*a - 3.8170677306326e-5*a*a*a + 0.0254471182042173*a*a + 4.77133466329075*a - 68.1619237612967;
